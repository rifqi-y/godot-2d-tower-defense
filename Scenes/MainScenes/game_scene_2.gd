...
func retrieve_wave_data():
	...
	var wave_data = [
		...
		["red_spirit", 15.0], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 5.0], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2],
		...
		["red_spirit", 15.0], ["red_spirit", 0.4], ["red_spirit", 0.4], ["red_spirit", 0.4], ["red_spirit", 0.4], ["red_spirit", 0.4], ["red_spirit", 0.4], ["red_spirit", 0.4], ["red_spirit", 0.4], ["red_spirit", 0.4], ["red_spirit", 0.4], ["red_spirit", 0.4], ["red_spirit", 0.4], ["red_spirit", 0.4], ["red_spirit", 0.4],
		["red_spirit", 15.0], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5], ["red_spirit", 0.5],
		["red_spirit", 15.0], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2], ["red_spirit", 0.2]
		]
...
func update_tower_preview():
	...
	var local_mouse = map_node1.get_node("TileMapLayer5").to_local(mouse_position)
	var current_tile = map_node1.get_node("TileMapLayer5").local_to_map(local_mouse)
	var tile_position = map_node1.get_node("TileMapLayer5").map_to_local(current_tile)
	
	if map_node1.get_node("TileMapLayer5").get_cell_source_id(current_tile) == -1:
...
func verify_and_build():
	...
	if build_valid:
		...
		if base_money >= tower_cost:
			...
			map_node1.get_node("Tower2").add_child(new_tower, true)
			map_node1.get_node("TileMapLayer5").set_cell(build_tile, 0, Vector2i(1,0))
